...
void invMechCableCoupling(struct mechanism *mech, int no_use_actual) {
    ...
    // Numeration: 1-shoulder; 2-eblow; 3-insertion; 4-tool rotation; 5-wrist; 6-upper grasper; 7-
    // lower grasper
    // -------------------------------------------------------------------------------------------------
    ...
    // C_l = [tr1                            0                               0             0   0   0
    //        0;
    //        tr2*CABLE_COUPLING_01          tr2                             0             0   0   0
    //        0;
    //        tr3*CABLE_COUPLING_02          tr3*CABLE_COUPLING_12           tr3           0   0   0
    //        0;
    //        tr3*CABLE_COUPLING_02/GB_RATIO tr3*CABLE_COUPLING_12G/B_RATIO  tr3/GB_RATIO  tr4 0   0
    //        0;
    //        tr3*CABLE_COUPLING_02/GB_RATIO tr3*CABLE_COUPLING_12G/B_RATIO  tr3/GB_RATIO  0   tr5 0
    //        0;
    //        tr3*CABLE_COUPLING_02/GB_RATIO tr3*CABLE_COUPLING_12G/B_RATIO  tr3/GB_RATIO  0   0
    //        tr6 0;
    //        tr3*CABLE_COUPLING_02/GB_RATIO tr3*CABLE_COUPLING_12G/B_RATIO  tr3/GB_RATIO  0   0  0
    //        tr7;]
    //
    // Green Arm - Right Arm:
    ...
    //        tr2*CABLE_COUPLING_01            tr2                             0          0   0   0
    //        0;
    //        tr3*CABLE_COUPLING_02            tr3*CABLE_COUPLING_12           tr3            0   0
    //        0  0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  tr4 0
    //        0  0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  0
    //        tr5 0  0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  0   0
    //        tr6 0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  0   0
    ...
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  tr4 0
    //        0   0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  0   tr
    //        0   0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  0
    //        tr6/2   tr6 0;
    //        -tr3*CABLE_COUPLING_02/GB_RATIO -tr3*CABLE_COUPLING_12G/B_RATIO  -tr3/GB_RATIO  0
