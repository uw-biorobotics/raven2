/* Auto-generated by genmsg_cpp for file /home/biorobotics/fresh_r2/raven_2/msg/raven_automove.msg */
...
struct raven_automove_ {
  ...
  ROS_DEPRECATED uint32_t get_del_pos_size() const { return (uint32_t)del_pos.size(); }
  ROS_DEPRECATED uint32_t get_tf_incr_size() const { return (uint32_t)tf_incr.size(); }
private:
  static const char* __s_getDataType_() { return "raven_2/raven_automove"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "409f695c901a20d6a1f90a4e55ae6f63"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, del_pos);
    ros::serialization::serialize(stream, tf_incr);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, del_pos);
    ros::serialization::deserialize(stream, tf_incr);
    return stream.getData();
  }
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(del_pos);
    size += ros::serialization::serializationLength(tf_incr);
    return size;
  }
